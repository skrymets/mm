...
import freemind.controller.actions.instance.MenuActionBase;
import freemind.controller.actions.instance.MenuCategoryBase;
import freemind.controller.actions.instance.MenuCheckedAction;
import freemind.controller.actions.instance.MenuRadioAction;
import freemind.controller.actions.instance.MenuSeparator;
import freemind.controller.actions.instance.MenuStructure;
import freemind.controller.actions.instance.MenuSubmenu;
import freemind.controller.actions.instance.Pattern;
import freemind.controller.actions.instance.PatternEdgeColor;
import freemind.controller.actions.instance.PatternEdgeStyle;
import freemind.controller.actions.instance.PatternEdgeWidth;
import freemind.controller.actions.instance.PatternIcon;
import freemind.controller.actions.instance.PatternNodeBackgroundColor;
import freemind.controller.actions.instance.PatternNodeColor;
import freemind.controller.actions.instance.PatternNodeFontBold;
import freemind.controller.actions.instance.PatternNodeFontItalic;
import freemind.controller.actions.instance.PatternNodeFontName;
import freemind.controller.actions.instance.PatternNodeFontSize;
import freemind.controller.actions.instance.PatternNodeStyle;
import freemind.controller.actions.instance.PatternNodeText;
...
public class MindMapController extends ControllerAdapter implements
    ...
    private ArrayList<HookAction> hookActions;
    // Mode mode;
    ...
    // Extension Actions
    public ArrayList<IconAction> iconActions = new ArrayList<>(); // fc
    ...
    public void processMenuCategory(StructuredMenuHolder holder, List<Object> list, String category) {
        ...
        for (Object obj : list) {
            if (obj instanceof MenuCategoryBase) {
                ...
                List<Object> objects = cat.getBaseList().stream()
                        .map((mcb) -> {
                            return (Object) mcb;
                        })
                        .collect(Collectors.toList());
