...
import freemind.controller.actions.xml.menus.MenuRadioAction;
import freemind.controller.actions.xml.menus.MenuSeparator;
import freemind.controller.actions.xml.menus.MenuStructure;
import freemind.controller.actions.xml.menus.MenuSubmenu;
...
public class MenuConfigService {
    ...
    public void processMenuCategory(StructuredMenuHolder holder, List<Object> list, String category) {
        ...
        for (var obj : list) {
            ...
            } else if (unwrapped instanceof MenuActionBase action) {
