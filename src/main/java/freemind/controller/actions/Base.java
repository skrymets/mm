...
public class Base
{
    ...
    private static final int MENU_CATEGORY_CHOICE = 0;
    private static final int MENU_SUBMENU_CHOICE = 1;
    private static final int MENU_ACTION_CHOICE = 2;
    private static final int MENU_CHECKED_ACTION_CHOICE = 3;
    private static final int MENU_RADIO_ACTION_CHOICE = 4;
    private static final int MENU_SEPARATOR_CHOICE = 5;
