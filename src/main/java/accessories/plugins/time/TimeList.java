...
import freemind.controller.actions.xml.storage.TimeWindowColumnSetting;
import freemind.controller.actions.xml.storage.TimeWindowConfigurationStorage;
    ...
    public void startupMapHook() {
        ...
        mFilterTextSearchField.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent pEvent) {
                // log.info("Key event:" + pEvent.getKeyCode());
                if (pEvent.getKeyCode() == KeyEvent.VK_DOWN) {
                    log.info("Set Focus to replace fields");
