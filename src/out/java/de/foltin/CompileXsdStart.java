...
public class CompileXsdStart extends DefaultHandler {
    ...
    private final TreeSet<String> mKeyOrder = new TreeSet<>();
    private final HashMap<String, HashMap<String, String>> mClassMap = new HashMap<>();

    private final StringBuffer mBindingXml = new StringBuffer();

    private final HashMap<String, ElementTypes> mElementMap = new HashMap<>();
    ...
    private class ElementTypes {
        ...
        ElementTypes(int pEnumerationId) {
    ...
    private void print() throws Exception {
        ...
        for (String className : mClassMap.keySet()) {
            ...
            try (FileOutputStream fs = new FileOutputStream(DESTINATION_DIR + "/" + className + ".java")) {
    ...
    private class ExtensionHandler extends XsdHandler {
        ...
        ExtensionHandler(XsdHandler pParent) {
            super(pParent);
        }
        ...
        public void startElement(String arg0, Attributes arg1) {
            ...
            getClassMap().put(KEY_CLASS_EXTENSION, " extends " + mExtendsClassName);
    ...
    private class SchemaHandler extends XsdHandler {
        ...
        SchemaHandler(XsdHandler pParent) {
            super(pParent);
        }
    ...
    private class ChoiceHandler extends XsdHandler {
        ...
        ChoiceHandler(XsdHandler pParent) {
            super(pParent);
        }
    ...
    private class ChoiceElementHandler extends XsdHandler {
        ...
        ChoiceElementHandler(XsdHandler pParent) {
            super(pParent);
    ...
    private class GroupHandler extends XsdHandler {
        ...
        GroupHandler(XsdHandler pParent) {
            super(pParent);
        }
    ...
    private class SequenceHandler extends XsdHandler {
        ...
        SequenceHandler(XsdHandler pParent) {
            super(pParent);
        }
    ...
    private class SequenceElementHandler extends XsdHandler {
        ...
        SequenceElementHandler(XsdHandler pParent) {
            super(pParent);
        }
        ...
        public void startElement(String arg0, Attributes arg1) {
            ...
            if (maxOccurs != null && maxOccurs.trim().equals("1")) {
                ...
                if (isRef) {
                    mBindingXml.append("      <structure field=\"").append(memberName).append("\" usage=\"").append(optReq).append("\" map-as=\"" + FREEMIND_PACKAGE + ".").append(type).append("\"/>\n");
                } else {
    ...
    private class ComplexTypeHandler extends XsdHandler {
        ...
        ComplexTypeHandler(XsdHandler pParent) {
            super(pParent);
        }
        ...
        public void endElement(String arg0, String arg1, String arg2) throws SAXException {
            if (mIsClassDefinedHere) {
                ...
                mBindingXml.append("  </mapping>\n" + "  <mapping name=\"").append(mRawName).append("\"").append(extendString).append(" class=\"" + FREEMIND_PACKAGE + ".").append(mClassName).append("\"><structure map-as=\"").append(mRawName).append("_type\"/></mapping>\n" + "\n");
            }
            super.endElement(arg0, arg1, arg2);
        }
    }
    ...
    private class ComplexContentHandler extends XsdHandler {
        ...
        ComplexContentHandler(XsdHandler pParent) {
            super(pParent);
        }
    ...
    private class AttributeHandler extends XsdHandler {
        ...
        AttributeHandler(XsdHandler pParent) {
            super(pParent);
        }
    ...
    private class EnumerationHandler extends XsdHandler {
        ...
        EnumerationHandler(XsdHandler pParent) {
            super(pParent);
        }
